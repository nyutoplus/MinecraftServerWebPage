...
<div>
	<div class="cmdof">
		...
		<div class="cmdma">インベントリを整理してアイテムを自動的にスタックします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">指定した領域を削除します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">指定した領域を保護します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">領域にメンバーを追加します。<br>※名前で追加した場合はプレイヤー名が変更されると外されます。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">領域の所有者を追加します。<br>※名前で追加した場合はプレイヤー名が変更されると外されます。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">領域からメンバーを削除します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">領域から所有者を削除します。<br>
	...
	<div class="cmdof">
		...
		<div class="cmdma">選択した領域をWorldEditの選択範囲に設定します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">指定された領域の情報を表示します。<br>領域が指定されていない場合は現在位置の情報を表示します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">作成されている領域の一覧を表示します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">指定した領域のフラグを設定します。<br>
	...
	<div class="cmdof">
		...
		<div class="cmdma">領域の優先度を設定します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">親領域を設定します。<br>親領域を指定しない場合は親領域を解除します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">領域を作成して保護します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">指定した領域を現在の選択範囲に置き換えます。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
	...
	<div class="cmdof">
		...
		<div class="cmdma">無敵モードを解除します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">プレイヤーを回復します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">プレイヤーをキルします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">リージョンフラグを適用する目的で保存されているプレイヤーに関する情報をクリアするためのコマンドです。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">現在のワールド、又は指定したワールドの火の炎上を停止します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">現在のワールド、又は指定したワールドの火の炎上を再開します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">全てのワールドのエンティティを削除し、すべての物理イベントと液体フローイベントが停止するモードに入ります。<br>更にチャンクがロードされるとそのチャンク内のエンティティが削除されます。<br>
	...
	<div class="cmdof">
		...
		<div class="cmdma">ラグの停止モードを無効化します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">ラグ停止モードの状態を表示します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">スポーン、又はテレポートフラグで指定された場所にテレポートします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">プラグインフォルダの中にレポートを作成します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">サーバーのCPU使用率のプロファイリングをします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">イベントシュミレーションをします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">WorldGuardのバージョンを表示します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">WorldGuardのデータをリロードします。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">WorldGuardの実行中のタスクを表示します。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">ファイル、又はデータベースから領域のデータをリロードします。<br>
	...
	<div class="cmdof">
		...
		<div class="cmdma">領域データを保存します。<br>領域データは変更が行われると自動的に保存されるため、このコマンドを明示的に呼び出す必要はありません。</div>
	</div>
	<hr>
	<div class="cmdof">
		<div class="cmdtt">
		...
		<div class="cmdma">データベースのタイプを移行します。<br>
	...
	<div class="cmdof">
		...
		<div class="cmdma">領域データのプレイヤー名をUUIDに変換します。<br>対応するUUIDを持たない名前はコンフィグによって削除されるか残されます。<br>
